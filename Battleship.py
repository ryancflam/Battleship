...
while not game.getWonBool():
    print(game.displayBoard(False))
    shipCount = game.getShipcount()
    print(str(shipCount) + " ship(s) left; attempt " + str(game.getAttempts() + 1))
    row = input("\nEnter row: ")
    col = input("Enter column: ")
    try:
        print("\nYou have " + game.takeTurn(row, col) + "\n")
    except Exception as ex:
        print(ex)


print(str(game.getTime()) + " seconds lasted")
